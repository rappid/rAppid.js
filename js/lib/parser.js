    ...
    parse: function(input, startRule) {
      ...
      function parse_varName() {
        ...
        var result2 = result1 !== null
          ? (function(start, end) {return start + end.join(""); })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_parameterArray() {
        ...
        if (result7 !== null) {
          ...
          var result11 = result10 !== null
            ? (function(r) {return r;})(result10[1])
            : null;
          if (result11 !== null) {
        ...
        var result6 = result5 !== null
          ? (function(s, rp) { if(s && s.name === "null") { s = null; }; for(var i = 0; i < rp.length;i++){ if(rp[i] && rp[i][0] && rp[i][0].name === "null") { rp[i] = null; }; }; return typeof s !== "undefined" ? [s].concat(rp) : []; })(result5[0], result5[1])
          : null;
        if (result6 !== null) {
          var result4 = result6;
        } else {
