...
var TestRunner = function(config) {
    ...
    return {
        ...
        createSystemManager: function (document) {
            return new rAppid.SystemManager(_applicationContext.$requirejsContext, this.getApplicationContext(), document);
        }
...
module.exports = {
    ...
    setup: function(config) {
        ...
        if (!config) {
            ...
            var modulePath = path.resolve("config.json");
