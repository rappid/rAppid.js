module.exports = function(options, moduleCallback) {
    ...
    flow()
        ...
        .seq(function() {
            returnObject.sessionId = this.vars["sessionId"];
                    ...
                    mocha = new Mocha({
                        ...
                        reporter: function (r) {
                            ...
                            r.on('pass', function (test) {
                                test.fileName = test;
                                passedTests.push(testResult(test, fileName));
                            });

                            r.on('fail', function (test, err) {
                                test = testResult(test, fileName, err);
        ...
        .seq(function () {
            ...
            returnObject.results.errorTests = errorTests;
            returnObject.results.failedTests = failedTests;
            returnObject.results.skippedTests = skippedTests;
            returnObject.results.passedTests = passedTests;
    ...
    function testResult(test, filename, error) {
        var path = [],
            parent = test.parent;
