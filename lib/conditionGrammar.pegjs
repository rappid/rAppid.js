...
and = o:operator rp:( d:" and " n:operator { return d ? n : null; } )* { return o && rp.length > 0  ? { type: "group", name: "and", args: [o].concat(rp) } : null; }
...
comparator = "=" {return "eq";} / ">=" { return "gte"; } / "<=" { return "lte" } / ">" {return "gt"} / "<" { return "lt" }
comparison = n:name c:comparator v:value { return {name: c, args: [n,v] }; }
group = "(" op:( or / and) ")" { return op; }
or = o:operator rp:( d:" or " o:operator { return d ? o : null; } )* { return o && rp.length > 0 ? { type: "group", name: "or", args: [o].concat(rp) } : null; }
