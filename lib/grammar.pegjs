...
parameter = string / boolean / float / number / staticBinding / path
parameterArray = s:parameter rp:("," r:parameter {return r;})* { return typeof s !== "undefined" ? [s].concat(rp) : []; } / "" {return []}
