define(['js/core/Component', 'srv/core/AuthorisationProvider', 'flow'],
    function (Component, AuthorisationProvider, flow) {

        return Component.inherit('srv.core.AuthorisationProviders', {
